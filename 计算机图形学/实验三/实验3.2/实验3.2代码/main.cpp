...
void display()
{
	...
	glm::mat4 shadowMatrix = {
		glm::vec4(-light_position.y, light_position.x, 0, 0), 
		glm::vec4(0, 0, 0, 0), 
		glm::vec4(0, light_position.z, -light_position.y, 0),
		glm::vec4(0, 1, 0, -light_position.y),
	};

	// 转置阴影矩阵，以适应 OpenGL 的列主序存储方式
...
int main(int argc, char **argv)
{
	...
	GLFWwindow* mainwindow = glfwCreateWindow(600, 600, "实验3.2", NULL, NULL);
	if (mainwindow == NULL)
	{
