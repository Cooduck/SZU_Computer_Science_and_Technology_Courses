...
void init()
{
	...
	// table->setShininess(100.0);						  //高光系数

	// 加到painter中
	painter->addMesh(table, "table", "./assets/table.png", vshader, fshader); 	// 指定纹理与着色器
	...
	// wawa->setShininess(100.0);						  //高光系数

	// 加到painter中
	painter->addMesh(wawa, "wawa", "./assets/wawa.png", vshader, fshader); 	// 指定纹理与着色器
...
int main(int argc, char** argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(600, 600, "实验四", NULL, NULL);
	if (window == NULL)
	{
