...
JOIN 
    user u ON pli.user_id = u.user_id
";
...
while ($row = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
    $items[] = [
        ...
        "lost_date_time" => $row["lost_date_time"],
...
<body>
    ...
    <main>
        <div class="items">
            ...
            <div class="item">
                ...
                <div class="item-title">[寻物] <?php echo $item['item_name']; ?></div>
                ...
                <div class="item-description hidden">物品丢失地点：<?php echo $item['lost_location']; ?></div>
                <div class="item-description hidden">丢失发布时间：<?php echo $item['lost_date_time']; ?></div>
    ...
    <div id="popup" class="popup">
        <div class="popup-content">
            ...
            <div id="popup-lost_location" class="item-description"></div>
            <div id="popup-lost_date_time" class="item-description"></div>
    ...
    <script>
        ...
        viewDetailsButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('popup-lost_location').textContent = '物品丢失地点：' + item.lost_location;
                document.getElementById('popup-lost_date_time').textContent = '丢失发布时间：' + item.lost_date_time;
